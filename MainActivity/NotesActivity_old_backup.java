...
public class NotesActivity extends AppCompatActivity {
    ...
    private JSONArray getItemsForFolder(String folderId) {
        try {
            if (folderId == null) {
                ...
                if (items == null) {
                    items = new JSONArray();
                    rootTree.put("items", items);
                }
                return items;
            }
            JSONArray result = findFolderChildren(rootTree.optJSONArray("items"), folderId);
    ...
    private void addNote() {
        ...
        b.setPositiveButton("Create", (d, w) -> {
            ...
            if (currentItems == null) {
                currentItems = getItemsForFolder(resolveCurrentFolderId());
            }
